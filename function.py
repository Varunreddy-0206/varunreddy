...
A1 = Aged('rama',75,'Male')
A2 = Aged('swathi',60,'Female')
A3 = Aged('Akhil',70,'Male')
A4 = Aged('kiran',70,'Male')
A5 = Aged('raju',70,'Male')
Alist = [A1,A2,A3,A4,A5]

Y1 = Young("ravi",25,'Male')
Y2 = Young("swarna",23,'Female')
Ylist = [Y1,Y2]
d = {}
